                ...
                <form className="max-w-md mx-auto">   
                    <div className="relative">
                        ...
                        <button 
                            type="button" 
                            onClick={addTask}
                            className="text-white absolute end-2.5 bottom-2.5 bg-emerald-600 hover:bg-emerald-700 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm px-3 py-2"
                        >
                            <svg 
                                xmlns="http://www.w3.org/2000/svg" 
                            ...
                            <div className="flex items-center space-x-4 rtl:space-x-reverse">
                                ...
                                <div className="inline-flex items-center text-base font-semibold text-gray-900">
                                    ...
                                    <button
                                        ...
                                        type="button" 
                                        className="px-2 py-2 text-sm font-medium text-white bg-indigo-600 rounded-lg focus:outline-none hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-300"
                                    >
                                    ...
                                    <button
                                        ...
                                        type="button" 
                                        className="px-2 py-2 mx-2 text-sm font-medium text-white rounded-lg focus:outline-none bg-amber-500 hover:bg-amber-600 focus:ring-4 focus:ring-amber-300"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-4">
                                    ...
                                    <button
                                        ...
                                        type="button" 
                                        className="px-2 py-2 text-sm font-medium text-white bg-red-600 rounded-lg focus:outline-none hover:bg-red-700 focus:ring-4 focus:ring-red-300"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-4">
